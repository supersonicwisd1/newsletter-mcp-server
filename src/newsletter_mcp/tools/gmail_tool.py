...
class GmailTool:
    ...
    def _setup_services(self):
        ...
        try:
            ...
            print("✅ Gmail API service initialized with OAuth2")
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            print(f"✅ Gmail connection test successful - Connected as: {profile.get('emailAddress', 'Unknown')}")
            return True
        except Exception as e:
...
Generated by Newsletter MCP Bot 🤖
    ...
    async def get_sender_email(self) -> str:
        ...
        try:
            ...
            print(f"Warning: Could not get sender email: {e}")
