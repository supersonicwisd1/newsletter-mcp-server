...
class GoogleDocsTool:
    ...
    def _setup_services(self):
        """Initialize Google API services with OAuth2"""
        try:
            creds = None
            ...
            print("✅ Google API services initialized with OAuth2")
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            if test_doc:
                ...
                print("✅ Google Docs connection test successful")
                return True
            return False
...
async def test_oauth_google_docs():
    ...
    try:
        print("🔍 Testing OAuth2 Google Docs integration...")
        ...
        print(f"✅ Newsletter document created!")
        print(f"   URL: {newsletter_doc['url']}")
        
        print(f"\n🎉 OAuth2 integration working perfectly!")
        print(f"   Test Doc: {doc_info['url']}")
        print(f"   Newsletter: {newsletter_doc['url']}")
